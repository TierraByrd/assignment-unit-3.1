...
let favoriteFoods = ['greens' , 'yams' , 'cornbread' , 'rice & gravy', 'beeftips'];
...
let dessert = 'Homemade peachcobbler';
...
gems [1] = 'Tourmaline'
console.log('Updated array: ', gems);
...
console.log('Reversed gems: ' , gems);
